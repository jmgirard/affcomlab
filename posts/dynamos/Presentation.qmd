...
## A Taxonomy of Emotion Ratings {.p90}
...
## Subjectivity Analysis {.p90}

- **Why do participants experience the same stimuli differently?**
    + Are such differences structured and predictable?
    
- **Are some stimuli more emotionally "subjective" than others?**
    + Can we predict this characteristic from stimulus features?

- **What can studying and modeling subjectivity help with?**
    + Identification of emotional dysregulation?
    + Personalized prediction of emotional reactions?
    + Personalized recommendations of affective content?
    + Standardization of affective content?
...
## Special thanks to the *Chromodoris*

...
:::{.callout-important}
>>>>>>> 2fe7002ed72d91ec89a57e444ef5ac63e80727ed
...
<<<<<<< HEAD
sudo apt-get install -y libcurl4-openssl-dev libssl-dev libxml2-dev libudunits2-dev libgdal-dev cargo libfontconfig1-dev libcairo2-dev gfortran cmake libavfilter-dev
sudo add-apt-repository ppa:c2d4u.team/c2d4u4.0+
sudo apt upgrade
sudo apt install -y --no-install-recommends r-cran-devtools r-cran-tidyverse r-cran-av
=======

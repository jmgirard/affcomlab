...
- *"Patient-focused Prediction of Dropout from PTSD Treatment"*
    ...
    - Currently in Review (will be scored in late September)

- *"Naturalistic Assessment of Communication Functions"*
    - R01, National Institutes of Health (NIMH)
    - Liebenthal (PI), Co-Is: **Girard**, Tie 
    - Not Scored, Currently in Revision (to submit in October)

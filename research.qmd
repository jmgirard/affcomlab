...
[R34, National Institutes of Health (NIAAA)]{.grant-funder}<br>[Sprunger (PI), Co-I: **Girard** · 05/2026 -- 04/2029]{.grant-people}
:::

::: {.grant-card}
Assessment of Eating Disorder and Comorbidity Risk and Resilience in Recent Military Enlistees

[Department of Defense (DoD)]{.grant-funder}<br>[Forbush (PI), Co-I: **Girard** · 04/2025 -- 03/2027]{.grant-people}
:::
...
[R34, National Institutes of Health (NIMH)]{.grant-funder}<br>[Forbush, Christensen-Pacella (PIs), Co-I: **Girard** · 01/2025 -- 12/2027]{.grant-people}
:::

::: {.grant-card}
COBRE Computational Assessment of Communicative Behaviors in Posttraumatic Stress

[P20, National Institutes of Health (COBRE)]{.grant-funder}<br>[**Girard** (PI) · 01/2025 -- 12/2026]{.grant-people}
:::
...
[R01, National Institutes of Health (NIMH)]{.grant-funder}<br>[Baker (PI), Co-Is: **Girard**, Morency · 04/2021 -- 02/2025]{.grant-people}
:::

::: {.grant-card}
Kansas Data Science Training Pathways | An Integrated Model

[National Science Foundation (EPSCoR REI)]{.grant-funder}<br>[**Girard** (PI) · 01/2024 -- 12/2024]{.grant-people}
:::

::: {.grant-card}
Novel Scalable Mental Health Screening Procedures on Ubiquitous Sensing Devices

[Googler-Initiated Grant, Google LLC]{.grant-funder}<br>[**Girard** (PI) · 11/2022]{.grant-people}
:::

::: {.grant-card}
Multimodal Dynamics of Parent-Child Interactions and Suicide Risk

[R21, National Institutes of Health (NIMH)]{.grant-funder}<br>[Burke (PI), Co-Is: **Girard**, Li, Morency · 09/2022 -- 07/2023]{.grant-people}
:::

::: {.grant-card}
Towards Automated Multimodal Behavioral Screening for Depression

[Pittsburgh Health Data Alliance (CMLH)]{.grant-funder}<br>[Morency (PI), Co-I: **Girard** · 03/2019 -- 02/2021]{.grant-people}
:::

::: {.grant-card}
Dyadic Behavior Informatics for Psychotherapy Process and Outcome

[National Science Foundation (IIS, SCH)]{.grant-funder}<br>[Cohn, Morency, Swartz (PIs), Co-Is: Bylsma, Fournier, **Girard** · 09/2020 -- 08/2022]{.grant-people}
:::
